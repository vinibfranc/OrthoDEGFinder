...
def search_organism(request):
    ...
    paginator = Paginator(organism_filter.qs, NUM_PAGES)
...
def search_gene(request):
    ...
    paginator = Paginator(gene_filter.qs, NUM_PAGES)
    page = request.GET.get('page')
...
def search_annotation(request):
    ...
    paginator = Paginator(annotation_filter.qs, NUM_PAGES)
    page = request.GET.get('page')
...
def search_orthologs(request):
    ...
    paginator = Paginator(orthologs_filter.qs, NUM_PAGES)
    page = request.GET.get('page')
...
def search_unified(request):
    ...
    paginator = Paginator(unified_filter.qs, NUM_PAGES)
    page = request.GET.get('page')
