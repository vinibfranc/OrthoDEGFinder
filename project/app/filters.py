...
class AnalysisAnnotatedGeneFilter(django_filters.FilterSet):
    ...
    log_fc = django_filters.ChoiceFilter(label='Log FC', choices=LOG_FC, method='filter_log_fc')
...
class UnifiedFilter(django_filters.FilterSet):
    ...
    gene_organism_1__log_fc  = django_filters.ChoiceFilter(label='Log FC', choices=LOG_FC, method='filter_log_fc_unified')
